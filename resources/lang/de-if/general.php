...
'2FA_reset'             => '2FA reset',
    ...
    'assets_available'		=> 'Verfügbare Gegenstände',
    'accept_assets'         => 'Gegenstände :name akzeptieren',
    'accept_assets_menu'    => 'Gegenstände akzeptieren',
    'audit'				    => 'Prüfung',
    'audit_report'			=> 'Prüfungsbericht',
    'assets'				=> 'Gegenstände',
    'assets_audited'        => 'Gegenstände geprüft',
    'assets_checked_in_count'     => 'Gegenstand zurückgenommen',
    'assets_checked_out_count'     => 'Gegenstände herausgegeben',
    'asset_deleted_warning'     => 'Dieser Gegenstand wurde gelöscht. Du musst ihn wiederherstellen, bevor du ihn jemandem zuweisen kannst.',
    ...
    'created_asset'			=> 'Gegenstand angelegt',
    ...
    'custom_report'         => 'Benutzerdefinierter Gegenstands-Bericht',
    'dashboard'				=> 'Dashboard',
    'days'      			=> 'Tage',
    ...
    'error'				    => 'Fehler',
    'exclude_archived'      => 'Archivierte Gegenstände ausschließen',
    'exclude_deleted'       => 'Gelöschte Gegenstände ausschließen',
    'example'				=> 'Beispiel: ',
    ...
    'importing_help'        => 'Du kannst Gegenstände, Zubehör, Lizenzen, Komponenten, Verbrauchsmaterialien und Benutzer mittels CSV-Datei importieren. <br><br>Die CSV-Datei sollte kommagetrennt sein und eine Kopfzeile enthalten, die mit den <a href="https://snipe-it.readme.io/docs/importing" target="_new">Beispiel-CSVs aus der Dokumentation</a> übereinstimmen.',
    ...
    'logout'				=> 'Abmelden',
    'lookup_by_tag'     => 'Nach Gegenstandskennzeichnung suchen',
...
'min_amt'				=> 'Mindestmenge',
    ...
    'audit_images_help'     => 'Du kannst Prüfbilder in der Gegenstands-Historie finden.',
    ...
    'qty'		            => 'Menge',
    'quantity'		        => 'Anzahl',
    'quantity_minimum'      => 'Du hast einen Gegenstand unter oder fast unter Mindestmenge Level|Du hast :count Gegenstände unterhalb oder fast unter Mindestmenge',
    'quickscan_checkin'  	=> 'Rücknahme',
    ...
    'requested_assets'      => 'Angeforderte Gegenstände',
    ...
    'select_asset'    		=> 'Wähle einen Gegenstand',
    ...
    'total_assets'			=> 'Gegenstände gesamt',
    ...
    'viewassets'  			=> 'Zugeordnete Gegenstände anzeigen',
    ...
    'audit_due_days'        => 'Fällige Gegenstände für Prüfung innerhalb von :days Tag|Fällige Gegenstände für Prüfung innerhalb von :days',
    'checkin_due'           => 'Fällig zum Check-in',
    'checkin_overdue'       => 'Überfällig für den Check-in',
    'checkin_due_days'      => 'Fällige Gegenstände für den Check-in innerhalb von :days Tag|Fällige Gegenstände für den Check-in innerhalb von :days',
    ...
    'reminder_checked_out_items' => 'Dies ist eine Erinnerung an die Gegenstände, die gerade an dich herausgegeben sind. Wenn du der Meinung bist, dass die Angaben falsch sind (fehlender Gegenstand oder Gegenstand, den du nie erhalten hast), sende bitte eine E-Mail an :reply_to_name unter :reply_to_address.',
    'changed'               => 'Geändert',
    'to'                    => 'An',
    'report_fields_info'    => '<p>Wähle die Felder aus, die du in deinem benutzerdefinierten Bericht einfügen möchtest, und klicke auf Generieren. Die Datei (custom-asset-report-YYYY-mm-dd.csv) wird automatisch heruntergeladen und du kannst diese in Excel öffnen.</p>
            <p>Wenn du nur bestimmte Gegenstände exportieren möchten, verwende die folgenden Optionen, um das Ergebnis zu verfeinern.</p>',
    'range'                 => 'Bereich',
    ...
    'asset_information'     => 'Gegenstands-Informationen',
    'model_name'            => 'Modellname',
    'asset_name'            => 'Gegenstandsname',
    ...
    'checkout_tooltip' => 'Diesen Gegenstand herausgeben',
    'checkin_tooltip' => 'Externer Link zu',
    'checkout_user_tooltip' => 'Diesen Gegenstand an einen Benutzer herausgeben',
    'checkin_to_diff_location' => 'Du kannst dich dafür entscheiden, diesen Gegenstand an einem anderen Ort als dem standardmäßigen Standort :default_location einzuchecken, falls einer festgelegt ist',
    ...
    'bulk_soft_delete'      =>'Auch diese Benutzer soft-löschen. Die Gegenstands-Historie bleibt erhalten, solange/bis die markierten Datensätze nicht in den Admin-Einstellungen endgültig gelöscht werden.',
    'bulk_checkin_delete_success' => 'Die ausgewählten Benutzer wurden gelöscht und ihre Gegenstände wurden eingecheckt.',
    'bulk_checkin_success' => 'Die Gegenstände der ausgewählten Benutzer wurden eingecheckt.',
    ...
    'assets_by_status'      => 'Gegenstände sortiert nach Status',
    'assets_by_status_type'      => 'Gegenstände sortiert nach Statustyp',
    'pie_chart_type'        => 'Dashboard Kreisdiagramm Typ',
    'hello_name'            => 'Hallo, :name!',
    'unaccepted_profile_warning'   => 'Du hast einen Gegenstand, der akzeptiert werden muss. Klicken hier, um ihn zu akzeptieren oder abzulehnen. | Du hast :count Gegenstände, die akzeptiert werden müssen. Klicke hier, um sie zu akzeptieren oder abzulehnen',
    ...
    'merge_information' =>  'Dies wird die :count Benutzer zu einem Benutzer zusammenführen. Wähle den Benutzer, in den du die anderen zusammenführen möchtest. Die zugehörigen Gegenstände, Lizenzen, etc. werden in den ausgewählten Benutzer verschoben und die anderen Benutzer werden als gelöscht markiert.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Das Generieren von fortlaufenden Gegenstands-Tags ist deaktiviert, daher müssen alle Datensätze die Spalte "Gegenstands-Tag" enthalten.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Hinweis: Das Generieren von fortlaufenden Gegenstands-Tags ist aktiviert, daher wird für alle Datensätze, die keinen Gegenstands-Tag angegeben haben, einer erstellt. Datensätze, die einen "Gegenstands-Tag" angegeben haben, werden mit den angegebenen Informationen aktualisiert.',
    ...
    'error_user_company' => 'Checkout Zielfirma und Gegenstands-Gesellschaft stimmen nicht überein',
    'error_user_company_accept_view' => 'Ein Gegenstand, welches dir zugewiesen wurde, gehört einem anderen Unternehmen, sodass du es nicht akzeptieren oder ablehnen kannst. Bitte prüfe das mit deinem Vorgesetzten',
    'importer' => [
        ...
        'checked_out_to_tag' => 'Herausgegeben an: Gegenstands-Tag',
    ...
    'copied' => 'Kopiert!',
    'status_compatibility' => 'Wenn Gegenstände bereits zugewiesen sind, können sie nicht zu einem nicht einsetzbaren Statustyp geändert werden, und diese Änderung wird übersprungen.',
    'rtd_location_help' => 'Dies ist der Ort des Gegenstands, wenn er nicht herausgegeben ist',
    ...
    'no_requestable' => 'Es gibt keine anforderbaren Gegenstände oder Gegenstands-Modelle.',

    'countable' => [
        'accessories' => ':count Zubehör|:count Zubehör',
        'assets' => ':count Gegenstand|:count Gegenstände',
    ...
    'more_info' => 'Mehr Info',
    'quickscan_bulk_help' => 'Wenn du dieses Kontrollkästchen aktivierst, wird der Gegenstands-Datensatz so bearbeitet, dass der neue Standort angezeigt wird. Wenn du es nicht aktivierst, wird der Standort nur im Prüfprotokoll vermerkt. Beachte, dass sich der Standort der Person, des Gegenstands oder des Standorts, an den er ausgecheckt wurde, nicht ändert, wenn dieser Gegenstand ausgecheckt wird.',
    'whoops' => 'Hoppla!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'Ein Gegenstand mit dem Gegenstands-Tag :asset_tag ist bereits vorhanden und es wurde keine Aktualisierung angefordert. Es wurden keine Änderungen vorgenommen.',
