...
return array(
    ...
    'delete' => array(
        ...
        'assoc_maintenances'	 => 'Este fornecedor esta atualmente associado a  :maintenances_count manutenção(ões) e não pode ser eliminado. Por favor, atualize as suas manutenções de artigos para que não referenciem este fornecedor e tente novamente.',
    )
